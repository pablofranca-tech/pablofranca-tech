...
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,spring,oracle,flutter,dart,javascript,html,css,git,github,vscode,figma" />
</p>
...
- <!-- Adicione aqui uma entrega concreta, ex.: "Desenvolvi X" -->
- <!-- Adicione aqui outra entrega, ex.: "Automatizei Y" -->
...
Sistema com arquitetura em camadas, autenticação JWT e integração com banco de dados.
...
App com consumo de APIs REST, gerenciamento de estado e interface responsiva.
